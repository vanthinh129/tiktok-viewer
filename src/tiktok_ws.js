...
class TikTokSocket {
            ...
            try {
                ...
                client.on('connect',async function (connection) {
                    ...
                    function _sendPing2() {
                        ...
                        // Send static connection alive ping
                        let randomNum = that.getRandomInt(5000, 10000)
                        randomNum = 5000
                ...
                const headers = {
                    ...
                    'Connection': 'Upgrade',
                    'Host': 'asdfs-ws-alisg.tiktap.com',
                    'Origin': 'https://asd.tiktap.com',
                    'Upgrade': 'websocket',
    ...
    createUrl({ room_id }) {
        ...
        let res = `wss://webcast-ws-asd.toptap.com` + this.generateRandomString(43)
        return res
    }
